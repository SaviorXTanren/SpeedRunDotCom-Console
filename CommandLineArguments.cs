...
namespace SpeedRunDotCom_Console
{
    public class CommandLineArguments
    {
        ...
        [Option('c', "Category", Required = true, Default = null, MetaValue = "ANY%/100%/etc..", HelpText = "The specific category for the game.")]
        public IEnumerable<string> CategoryList { get; set; }

        [Option('w', "WorldRecord", Group = "SearchType", HelpText = "Whether to show the world record time or not. The -w or -u arguments is required.")]
        public bool WorldRecord { get; set; }

        [Option('u', "Username", Group = "SearchType", MetaValue = "USERNAME", HelpText = "Username to look up record for. The -w or -u arguments is required.")]
