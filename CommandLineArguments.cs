...
namespace SpeedRunDotCom_Console
{
    ...
    {
        [Option('g', "Game", Required = true, MetaValue = "GAME NAME")]
        ...
        [Option('w', "WorldRecord", Group = "SearchType", HelpText = "Whether to show the world record time or not")]
        public bool WorldRecord { get; set; }

        [Option('u', "Username", Group = "SearchType", MetaValue = "USERNAME", HelpText = "Username to look up record for")]
